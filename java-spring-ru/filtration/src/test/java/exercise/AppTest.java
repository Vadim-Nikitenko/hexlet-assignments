...
public class AppTest {
    ...
    // BEGIN
    @Test
    void testFilterByAllFilters1() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users?firstName=retha&lastName=astupenas&gender=Female"))
                .andReturn()
                .getResponse();
    ...
    @Test
    void testFilterByAllFilters2() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(get("/users?firstName=Retha&lastName=Astupenas&gender=female"))
                .andReturn()
                .getResponse();
